...
public:
    ...
    void resetFromROSParam(ros::NodeHandle &_nh) {
        ...
        _nh.param("a1_default_foot_pos_FL_x", a1_default_foot_pos_FL_x, 0.17);
        _nh.param("a1_default_foot_pos_FL_y", a1_default_foot_pos_FL_y, 0.15);
        _nh.param("a1_default_foot_pos_FL_z", a1_default_foot_pos_FL_z, -0.35);

        _nh.param("a1_default_foot_pos_FR_x", a1_default_foot_pos_FR_x, 0.17);
        _nh.param("a1_default_foot_pos_FR_y", a1_default_foot_pos_FR_y, -0.15);
        _nh.param("a1_default_foot_pos_FR_z", a1_default_foot_pos_FR_z, -0.35);
        ...
        _nh.param("a1_default_foot_pos_RL_z", a1_default_foot_pos_RL_z, -0.35);
        ...
        _nh.param("q_weights_5", q_weights_5, 420.0);

        _nh.param("q_weights_6", q_weights_6, 0.05);
        _nh.param("q_weights_7", q_weights_7, 0.05);
        _nh.param("q_weights_8", q_weights_8, 0.05);

        _nh.param("q_weights_9", q_weights_9, 30.0);
        _nh.param("q_weights_10", q_weights_10, 30.0);
        _nh.param("q_weights_11", q_weights_11, 10.0);
        ...
        _nh.param("r_weights_2", r_weights_2, 1e-7);

        _nh.param("r_weights_3", r_weights_3, 1e-7);
        _nh.param("r_weights_4", r_weights_4, 1e-7);
        _nh.param("r_weights_5", r_weights_5, 1e-7);

        _nh.param("r_weights_6", r_weights_6, 1e-7);
        _nh.param("r_weights_7", r_weights_7, 1e-7);
        _nh.param("r_weights_8", r_weights_8, 1e-7);

        _nh.param("r_weights_9", r_weights_9, 1e-7);
        ...
        _nh.param("a1_kp_foot_z", a1_kp_foot_z, 150.0);

        _nh.param("a1_kd_foot_x", a1_kd_foot_x, 10.0);
        _nh.param("a1_kd_foot_y", a1_kd_foot_y, 10.0);
        _nh.param("a1_kd_foot_z", a1_kd_foot_z, 5.0);
        ...
        _nh.param("a1_gait_counter_speed_FL", a1_gait_counter_speed_FL, 1.5);
        _nh.param("a1_gait_counter_speed_FR", a1_gait_counter_speed_FR, 1.5);
    ...
    Eigen::Matrix<double, NUM_DOF, 1> Coriolis_torques;
    ...
    std::string fr_foot_link;
    std::string rl_foot_link;
    std::string rr_foot_link;
